...
|---|---|---|---|
| `standard` | 标准商务 | 深蓝 `1F4E79` / 深橙 `A34A00` | 方案、报告、说明、对账、投标技术文件 |
| `govdoc` | 党政机关公文 | 沿用 `standard` 色板；正文与标题为黑色 | 正式发文（通知、通报、请示、报告、函、纪要） |
| `compact` | 内部纪要 | 灰蓝 `44546A` / 深橙 `A34A00` | 内部备忘、会议纪要、任务清单、草稿 |
| `report` | 汇报报告 | 深橙 `A34A00` / 表头底纹 `BDD7EE` | 汇报、总结、复盘、数据分析报告 |
