...
window.__ModuleLoader__.load({
  ...
  chainStepCheckWarn: '提示：',
      ...
      // 这张卡**只管知识库**：记忆体不在这里搬 —— 它在执行链第 1 步已经自动迁完
      importTitle: '已有旧知识库要带过来？',
      importSub: '本机已有知识库时，由你指定文件夹后再搬 —— 知识库不会自动搬，指定后逐项对照',
  ...
  chainStepCheckWarn: 'Notice: ', 
      ...
      // This card only covers the vault: the memory store is not moved here — step 1 of the chain already migrated it.
      importTitle: 'Bring an existing vault over?',
      importSub: 'If you already have a vault here, pick the folder and it is brought over — a vault is never moved automatically, and each item is compared before writing',
