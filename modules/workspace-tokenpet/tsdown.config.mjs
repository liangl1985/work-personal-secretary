// Client bundle for workspace-tokenpet: emits the __ModuleLoader__.load factory the
// dsh web plugin table serves at /plugins/workspace-tokenpet/client.js. Externals are
